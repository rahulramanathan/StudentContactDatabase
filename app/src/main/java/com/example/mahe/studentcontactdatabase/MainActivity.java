package com.example.mahe.studentcontactdatabase;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS Student(id INTEGER,name VARCHAR,sem INTEGER,branch VARCHAR,faculty VARCHAR,phone INTEGER,email VARCHAR);");
    }
